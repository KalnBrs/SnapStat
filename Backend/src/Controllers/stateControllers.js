...
const updateState = async (req, res) => {
  const allowedColumns = ['quarter', 'down', 'distance', 'ball_on_yard', 'possession_team_id', 'current_drive_id', 'home_timeouts', 'away_timeouts', "home_score", "away_score", 'finished', 'date']
  const setClauses = []
  const values = []
  let index = 1
